...
import com.stackroute.MusicService.service.MusicServiceImplementation;
...
private Music music;
    ...
    @InjectMocks
    private MusicServiceImplementation musicService;
    ...
    public void setUp(){
        ...
        music = new Music();
        music.setMusicId(10);
        music.setMusicName("Beautiful");
        music.setComment("Singer : Akon");
        list = new ArrayList<>();
        list.add(music);
